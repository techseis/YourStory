...
using YStory.Core.Domain.Shipping;
...
using YStory.Services.Shipping;
...
namespace YStory.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual ActionResult Index()
        {
            ...
            bool downloadableArticlesRequireRegistration =
                _customerSettings.RequireRegistrationForDownloadableArticles && cart.Any(sci => sci.Article.IsDownload);

            if (_workContext.CurrentCustomer.IsGuest() 
                && (!_subscriptionSettings.AnonymousCheckoutAllowed
                    || downloadableArticlesRequireRegistration)
                )
