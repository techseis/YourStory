...
namespace YStory.Core.Domain.Customers
{
    ...
    public partial class Customer : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the contributor identifier with which this customer is associated (maganer)
        /// </summary>
        public int ContributorId { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether this customer has some articles in the shopping cart
