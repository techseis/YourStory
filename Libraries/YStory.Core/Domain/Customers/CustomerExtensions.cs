...
namespace YStory.Core.Domain.Customers
{
    public static class CustomerExtensions
    {
        ...
        /// <summary>
        /// Gets a value indicating whether customer is contributor
        /// </summary>
        /// <param name="customer">Customer</param>
        /// <param name="onlyActiveCustomerRoles">A value indicating whether we should look only in active customer roles</param>
        /// <returns>Result</returns>
        public static bool IsContributor(this Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return IsInCustomerRole(customer, SystemCustomerRoleNames.Contributors, onlyActiveCustomerRoles);
        }
        #endregion
