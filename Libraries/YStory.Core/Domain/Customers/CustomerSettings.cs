...
namespace YStory.Core.Domain.Customers
{
    public class CustomerSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to hide 'Downloable articles' tab on 'My account' page
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to validate user when downloading articles
        /// </summary>
        public bool DownloadableArticlesValidateUser { get; set; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether registration is required for downloadable articles
        /// </summary>
