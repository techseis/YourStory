...
namespace YStory.Core.Domain.Customers
{
    ...
    public partial class RewardPointsHistory : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the subscription for which points were redeemed as a payment (spent by a customer when placing this subscription)
        /// </summary>
        public virtual Subscription UsedWithSubscription { get; set; }
