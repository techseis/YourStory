...
namespace YStory.Core.Domain.Subscriptions
{
    ...
    public partial class RecurringPayment : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the initial subscription identifier
        /// </summary>
        ...
        /// </summary>
        public RecurringArticleCyclePeriod CyclePeriod
        {
            get
            {
                return (RecurringArticleCyclePeriod)this.CyclePeriodId;
            }
            set
            {
        ...
        /// <summary>
        /// Gets the initial subscription
        /// </summary>
        public virtual Subscription InitialSubscription { get; set; }
    }
}
