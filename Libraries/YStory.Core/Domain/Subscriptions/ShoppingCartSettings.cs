...
namespace YStory.Core.Domain.Subscriptions
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether a custoemr should be redirected to the shopping cart page after adding a article to the cart/wishlist
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to show article images in the mini-shopping cart block
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to show article image on shopping cart page
        /// </summary>
        public bool ShowArticleImagesOnShoppingCart { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to show article image on wishlist page
        /// </summary>
        ...
        /// <summary>Gets or sets a maximum number of articles which can be displayed in the mini-shopping cart block
        /// </summary>
        public int MiniShoppingCartArticleNumber { get; set; }
        
        //Round is already an issue. 
        //When enabled it can cause one issue: http://www.yourstory.com/boards/t/7679/vattax-rounding-error-important-fix.aspx
        //When disable it causes another one: http://www.yourstory.com/boards/t/11419/nop-20-subscription-of-steps-in-checkout.aspx?p=3#46924
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether a customer will beable to edit articles in the cart
        /// </summary>
        public bool AllowCartItemEditing { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether a customer will see quantity of attribute values associated to articles (when qty > 1)
        /// </summary>
