...
namespace YStory.Core.Domain.Tax
{
    public class TaxSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to hide tax in subscription summary when prices are shown tax inclusive
        /// </summary>
        public bool HideTaxInSubscriptionSummary { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether we should always exclude tax from subscription subtotal (no matter of selected tax dispay type)
        /// </summary>
        public bool ForceTaxExclusionFromSubscriptionSubtotal { get; set; }

        /// <summary>
        /// Gets or sets a default tax category identifier for articles
        /// </summary>
