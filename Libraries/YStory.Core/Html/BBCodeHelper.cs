...
using YStory.Core.Html.CodeFormatter;
using YStory.Core.Infrastructure;

namespace YStory.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the url tags: [url=http://www.yourStory.com]my site[/url]
                // becomes: <a href="http://www.yourStory.com">my site</a>
                text = regexUrl1.Replace(text, string.Format("<a href=\"$1\" rel=\"nofollow\"{0}>$2</a>", newWindow ? " target=_blank" : ""));

                // format the url tags: [url]http://www.yourStory.com[/url]
                // becomes: <a href="http://www.yourStory.com">http://www.yourStory.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]http://www.yourStory.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="http://www.yourStory.com/Content/Images/Image.jpg">
