 ...
 *      in a article, an acknowledgment in the article documentation would be
...
namespace YStory.Core.Html.CodeFormatter
{
	/// <summary>
		...
		protected override string Keywords
		{
			get
			{
				return "absolute action ada add admin after aggregate "
					...
					+ "openquery openrowset openxml operation option or subscription "
					+ "ordinality out outer output over overlaps pad parameter "
					+ "parameters partial pascal path percent plan position "
					+ "postfix precision prefix presubscription prepare preserve "
