...
namespace YStory.Core.Plugins
{
    ...
    public static class PluginFileParser
    {
        ...
        public static PluginDescriptor ParsePluginDescriptionFile(string filePath)
        {
            ...
            foreach (var setting in settings)
            {
                ...
                switch (key)
                {
                    ...
                    case "DisplaySubscription":
                        {
                            int displaySubscription;
                            int.TryParse(value, out displaySubscription);
                            descriptor.DisplaySubscription = displaySubscription;
                        }
                        break;
                    case "FileName":
            ...
            //yourStory 2.00 didn't have 'SupportedVersions' parameter
        ...
        public static void SavePluginDescriptionFile(PluginDescriptor plugin)
        {
            ...
            keyValues.Add(new KeyValuePair<string, string>("DisplaySubscription", plugin.DisplaySubscription.ToString()));
