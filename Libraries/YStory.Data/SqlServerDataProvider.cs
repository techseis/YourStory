...
using YStory.Data.Initializers;
...
namespace YStory.Data
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have yourStory 2.X installed
            var tablesToValidate = new[] { "Customer", "Discount", "Subscription", "Article", "ShoppingCartItem" };
            ...
            var initializer = new CreateTablesIfNotExist<YStoryObjectContext>(tablesToValidate, customCommands.ToArray());
