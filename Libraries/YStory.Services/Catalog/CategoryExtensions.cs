...
namespace YStory.Services.Catalog
{
    ...
    public static class CategoryExtensions
    {
        ...
        /// <summary>
        /// Returns a ArticleCategory that has the specified values
        /// </summary>
        /// <param name="source">Source</param>
        /// <param name="articleId">Article identifier</param>
        /// <param name="categoryId">Category identifier</param>
        /// <returns>A ArticleCategory that has the specified values; otherwise null</returns>
        public static ArticleCategory FindArticleCategory(this IList<ArticleCategory> source,
            int articleId, int categoryId)
        {
            foreach (var articleCategory in source)
                if (articleCategory.ArticleId == articleId && articleCategory.CategoryId == categoryId)
