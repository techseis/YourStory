...
namespace YStory.Services.Catalog
{
    ...
    public partial interface ISpecificationAttributeService
    {
        ...
        IList<ArticleSpecificationAttribute> GetArticleSpecificationAttributes(int articleId = 0,
        ...
        int GetArticleSpecificationAttributeCount(int articleId = 0, int specificationAttributeOptionId = 0);
