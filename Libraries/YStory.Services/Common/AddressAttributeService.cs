...
namespace YStory.Services.Common
{
    ...
    public partial class AddressAttributeService : IAddressAttributeService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string ADDRESSATTRIBUTES_ALL_KEY = "YStory.addressattribute.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string ADDRESSATTRIBUTES_BY_ID_KEY = "YStory.addressattribute.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : address attribute ID
        /// </remarks>
        private const string ADDRESSATTRIBUTEVALUES_ALL_KEY = "YStory.addressattributevalue.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string ADDRESSATTRIBUTEVALUES_BY_ID_KEY = "YStory.addressattributevalue.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ADDRESSATTRIBUTES_PATTERN_KEY = "YStory.addressattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ADDRESSATTRIBUTEVALUES_PATTERN_KEY = "YStory.addressattributevalue.";
        #endregion
        ...
        public virtual IList<AddressAttribute> GetAllAddressAttributes()
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                var query = from aa in _addressAttributeRepository.Table
                            orderby aa.DisplaySubscription, aa.Id
                            select aa;
                return query.ToList();
            });
        }
        ...
        public virtual IList<AddressAttributeValue> GetAddressAttributeValues(int addressAttributeId)
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                var query = from aav in _addressAttributeValueRepository.Table
                            orderby aav.DisplaySubscription, aav.Id
