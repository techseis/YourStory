...
namespace YStory.Services.Customers
{
    ...
    public partial class CustomerReportService : ICustomerReportService
    {
        ...
        public CustomerReportService(IRepository<Customer> customerRepository,
            IRepository<Subscription> subscriptionRepository, ICustomerService customerService,
            ...
            int pageIndex = 0, int pageSize = 214748364)
        {
            ...
            var query1 = from c in _customerRepository.Table
                         join o in _subscriptionRepository.Table on c.Id equals o.CustomerId
            ...
            var query2 = from co in query1
                         ...
                         {
                             CustomerId = g.Key,
                             SubscriptionTotal = g.Sum(x => x.o.SubscriptionTotal),
            ...
            switch (subscriptionBy)
            {
                case 1:
                    {
                        query2 = query2.OrderByDescending(x => x.SubscriptionTotal);
                    }
                    break;
                case 2:
                    {
                        query2 = query2.OrderByDescending(x => x.SubscriptionCount);
                    }
                    break;
                default:
            ...
            return new PagedList<BestCustomerReportLine>(tmp.Select(x => new BestCustomerReportLine
                {
                    ...
                    SubscriptionTotal = x.SubscriptionTotal,
