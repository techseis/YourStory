...
namespace YStory.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        /// </remarks>
        private const string CUSTOMERROLES_ALL_KEY = "YStory.customerrole.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : system name
        /// </remarks>
        private const string CUSTOMERROLES_BY_SYSTEMNAME_KEY = "YStory.customerrole.systemname-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CUSTOMERROLES_PATTERN_KEY = "YStory.customerrole.";
        ...
        private readonly IRepository<ArticleReviewHelpfulness> _articleReviewHelpfulnessRepository;
        ...
        public CustomerService(ICacheManager cacheManager,
            ...
            IRepository<ArticleReviewHelpfulness> articleReviewHelpfulnessRepository,
            ...
            CommonSettings commonSettings)
        {
            ...
            this._articleReviewHelpfulnessRepository = articleReviewHelpfulnessRepository;
        ...
        /// <param name="customerRoleIds">A list of customer role identifiers to filter by (at least one match); pass null or empty list in subscription to load all customers; </param>
        ...
        public virtual IPagedList<Customer> GetAllCustomers(DateTime? createdFromUtc = null,
            DateTime? createdToUtc = null, int affiliateId = 0, int contributorId = 0,
            ...
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            if (contributorId > 0)
                query = query.Where(c => contributorId == c.ContributorId);
        ...
        public virtual void DeleteCustomer(Customer customer)
        {
            ...
            if (customer.IsSystemAccount)
                throw new YStoryException(string.Format("System customer account ({0}) could not be deleted", customer.SystemName));
        ...
        public virtual Customer InsertGuestCustomer()
        {
            ...
            if (guestRole == null)
                throw new YStoryException("'Guests' role could not be loaded");
        ...
        public virtual int DeleteGuestCustomers(DateTime? createdFromUtc, DateTime? createdToUtc, bool onlyWithoutShoppingCart)
        {
            ...
            else
            {
                ...
                query = from c in query
                        join o in _subscriptionRepository.Table on c.Id equals o.CustomerId into c_o
                ...
                //no article reviews
                query = from c in query
                        join pr in _articleReviewRepository.Table on c.Id equals pr.CustomerId into c_pr
                        from pr in c_pr.DefaultIfEmpty()
                        where !c_pr.Any()
                        select c;
                //no article reviews helpfulness
                query = from c in query
                        join prh in _articleReviewHelpfulnessRepository.Table on c.Id equals prh.CustomerId into c_prh
        ...
        public virtual void DeleteCustomerRole(CustomerRole customerRole)
        {
            ...
            if (customerRole.IsSystemRole)
                throw new YStoryException("System role could not be deleted");
