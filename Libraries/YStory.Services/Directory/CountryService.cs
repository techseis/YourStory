...
namespace YStory.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        /// </remarks>
        private const string COUNTRIES_ALL_KEY = "YStory.country.all-{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string COUNTRIES_PATTERN_KEY = "YStory.country.";
        ...
        public virtual IList<Country> GetAllCountries(int languageId = 0, bool showHidden = false)
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                ...
                query = query.OrderBy(c => c.DisplaySubscription).ThenBy(c => c.Name);
                ...
                if (languageId > 0)
                {
                    //we should sort countries by localized names when they have the same display subscription
                    countries = countries
