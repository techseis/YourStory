...
namespace YStory.Services.Forums
{
    /// <summary>
    /// Forum service
    /// </summary>
    public partial class ForumService : IForumService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string FORUMGROUP_ALL_KEY = "YStory.forumgroup.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : forum group ID
        /// </remarks>
        private const string FORUM_ALLBYFORUMGROUPID_KEY = "YStory.forum.allbyforumgroupid-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string FORUMGROUP_PATTERN_KEY = "YStory.forumgroup.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string FORUM_PATTERN_KEY = "YStory.forum.";
        ...
        public virtual IList<ForumGroup> GetAllForumGroups()
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                var query = from fg in _forumGroupRepository.Table
                            orderby fg.DisplaySubscription, fg.Id
                            select fg;
                return query.ToList();
            });
        }
        ...
        public virtual IList<Forum> GetAllForumsByGroupId(int forumGroupId)
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                var query = from f in _forumRepository.Table
                            orderby f.DisplaySubscription, f.Id
        ...
        /// <param name="customerId">The customer identifier</param>
        /// <param name="keywords">Keywords</param>
        /// <param name="ascSort">Sort subscription</param>
        /// <param name="pageIndex">Page index</param>
        /// <param name="pageSize">Page size</param>
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            if (customerTo == null)
            {
                throw new YStoryException("Recipient could not be loaded");
            }
        ...
        public virtual ForumSubscription GetOrderById(int forumSubscriptionId)
        {
