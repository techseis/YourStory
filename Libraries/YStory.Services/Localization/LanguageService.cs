...
namespace YStory.Services.Localization
{
    ...
    public partial class LanguageService : ILanguageService
    {
        ...
        /// {0} : language ID
        /// </remarks>
        private const string LANGUAGES_BY_ID_KEY = "YStory.language.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string LANGUAGES_ALL_KEY = "YStory.language.all-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string LANGUAGES_PATTERN_KEY = "YStory.language.";
        ...
        public virtual IList<Language> GetAllLanguages(bool showHidden = false, int storeId = 0)
        {
            ...
            var languages = _cacheManager.Get(key, () =>
            {
                ...
                query = query.OrderBy(l => l.DisplaySubscription).ThenBy(l => l.Id);
                return query.ToList();
            });
