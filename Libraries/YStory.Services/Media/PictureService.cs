...
namespace YStory.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
            ...
            ResizeType resizeType = ResizeType.LongestSide, bool ensureSizePositive = true)
        {
            ...
            //we invoke Math.Round to ensure that no white background is rendered - http://www.yourstory.com/boards/t/40616/image-resizing-bug.aspx
        ...
        /// <summary>
        /// Gets pictures by article identifier
        /// </summary>
        /// <param name="articleId">Article identifier</param>
        /// <param name="recordsToReturn">Number of records to return. 0 if you want to get all items</param>
        /// <returns>Pictures</returns>
        public virtual IList<Picture> GetPicturesByArticleId(int articleId, int recordsToReturn = 0)
        {
            if (articleId == 0)
            ...
            var query = from p in _pictureRepository.Table
                        join pp in _articlePictureRepository.Table on p.Id equals pp.PictureId
            ...
            set
            {
                ...
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        //detach them in subscription to release memory
                        foreach (var picture in pictures)
                        {
