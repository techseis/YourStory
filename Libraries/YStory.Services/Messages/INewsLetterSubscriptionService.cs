...
namespace YStory.Services.Messages
{
    ...
    public partial interface INewsLetterSubscriptionService
    {
        ...
        NewsLetterSubscription GetNewsLetterOrderById(int newsLetterSubscriptionId);
        ...
        /// <returns>NewsLetter subscription</returns>
        NewsLetterSubscription GetNewsLetterOrderByGuid(Guid newsLetterSubscriptionGuid);
        ...
        /// <returns>NewsLetter subscription</returns>
        NewsLetterSubscription GetNewsLetterOrderByEmailAndStoreId(string email, int storeId);
