...
namespace YStory.Services.Messages
{
    ...
    public class NewsLetterSubscriptionService : INewsLetterSubscriptionService
    {
        ...
        public virtual NewsLetterSubscription GetNewsLetterOrderById(int newsLetterSubscriptionId)
        {
        ...
        /// <returns>NewsLetter subscription</returns>
        public virtual NewsLetterSubscription GetNewsLetterOrderByGuid(Guid newsLetterSubscriptionGuid)
        {
        ...
        /// <returns>NewsLetter subscription</returns>
        public virtual NewsLetterSubscription GetNewsLetterOrderByEmailAndStoreId(string email, int storeId)
        {
