...
namespace YStory.Services.Payments
{
    ...
    public static class PaymentExtensions
    {
        ...
        /// <summary>
        /// Deerialize CustomValues of Subscription
        /// </summary>
        /// <param name="subscription">Subscription</param>
        /// <returns>Serialized CustomValues CustomValues</returns>
        public static Dictionary<string, object> DeserializeCustomValues(this Subscription subscription)
        {
            if (subscription == null)
                throw new ArgumentNullException("subscription");

            var request = new ProcessPaymentRequest();
            return request.DeserializeCustomValues(subscription.CustomValuesXml);
        }
        /// <summary>
