...
namespace YStory.Services.Payments
{
    ...
    public partial class ProcessPaymentRequest
    {
        ...
        /// <summary>
        /// Gets or sets an subscription unique identifier. Used when subscription is not saved yet (payment gateways that do not redirect a customer to a third-party URL)
        /// </summary>
        public Guid SubscriptionGuid { get; set; }

        /// <summary>
        /// Gets or sets an subscription total
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets an initial (parent) subscription identifier if subscription is recurring
        /// </summary>
        ...
        /// </summary>
        public RecurringArticleCyclePeriod RecurringCyclePeriod { get; set; }
