...
namespace YStory.Services.Stores
{
    /// <summary>
    /// Store service
    /// </summary>
    public partial class StoreService : IStoreService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string STORES_ALL_KEY = "YStory.stores.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : store ID
        /// </remarks>
        private const string STORES_BY_ID_KEY = "YStory.stores.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string STORES_PATTERN_KEY = "YStory.stores.";
        ...
        public virtual IList<Store> GetAllStores()
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                var query = from s in _storeRepository.Table
                            orderby s.DisplaySubscription, s.Id
                            select s;
