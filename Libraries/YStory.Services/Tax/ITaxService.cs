...
namespace YStory.Services.Tax
{
    ...
    public partial interface ITaxService
    {
        ...
        decimal GetArticlePrice(Article article, decimal price,
            out decimal taxRate);
        ...
        /// <param name="taxRate">Tax rate</param>
        /// <returns>Price</returns>
        decimal GetArticlePrice(Article article, int taxCategoryId, decimal price,
        ...
        bool IsTaxExempt(Article article, Customer customer);
