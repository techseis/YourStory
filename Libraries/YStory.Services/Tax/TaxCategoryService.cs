...
namespace YStory.Services.Tax
{
    ...
    public partial class TaxCategoryService : ITaxCategoryService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string TAXCATEGORIES_ALL_KEY = "YStory.taxcategory.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : tax category ID
        /// </remarks>
        private const string TAXCATEGORIES_BY_ID_KEY = "YStory.taxcategory.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string TAXCATEGORIES_PATTERN_KEY = "YStory.taxcategory.";
        ...
        public virtual IList<TaxCategory> GetAllTaxCategories()
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                var query = from tc in _taxCategoryRepository.Table
                            orderby tc.DisplaySubscription, tc.Id
                            select tc;
