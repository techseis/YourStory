...
namespace YStory.Services.Tax
{
    ...
    public partial class TaxService : ITaxService
    {
        ...
        protected virtual CalculateTaxRequest CreateCalculateTaxRequest(Article article,
            int taxCategoryId, Customer customer, decimal price)
        {
            ...
            var calculateTaxRequest = new CalculateTaxRequest
            {
                ...
                Article = article,
                Price = price,
                TaxCategoryId = taxCategoryId > 0 ? taxCategoryId : (article != null ? article.TaxCategoryId : 0)
            };
            ...
            var overridenBasedOn = _taxSettings.EuVatEnabled                                            //EU VAT enabled?
                && article != null     //telecommunications, broadcasting and electronic services?
        ...
        protected virtual void GetTaxRate(Article article, int taxCategoryId, 
            Customer customer, decimal price, out decimal taxRate, out bool isTaxable)
        {
            ...
            //tax request
            var calculateTaxRequest = CreateCalculateTaxRequest(article, taxCategoryId, customer, price);

            //tax exempt
            if (IsTaxExempt(article, calculateTaxRequest.Customer))
            {
                isTaxable = false;
            }
        ...
        public virtual decimal GetArticlePrice(Article article, decimal price, 
            out decimal taxRate)
        {
            var customer = _workContext.CurrentCustomer;
            return GetArticlePrice(article, price, customer, out taxRate);
        }
            ...
            Customer customer, out decimal taxRate)
        {
            ...
            return GetArticlePrice(article, price, includingTax, customer, out taxRate);
        }
            ...
            bool includingTax, Customer customer, out decimal taxRate)
        {
            ...
            int taxCategoryId = 0;
            return GetArticlePrice(article, taxCategoryId, price, includingTax, 
        ...
        /// <param name="taxRate">Tax rate</param>
        /// <returns>Price</returns>
        public virtual decimal GetArticlePrice(Article article, int taxCategoryId,
            ...
            bool priceIncludesTax, out decimal taxRate)
        {
            ...
            bool isTaxable;
            GetTaxRate(article, taxCategoryId, customer, price, out taxRate, out isTaxable);
        ...
        /// <summary>
        /// Gets a value indicating whether a article is tax exempt
        /// </summary>
        /// <param name="article">Article</param>
        /// <param name="customer">Customer</param>
        /// <returns>A value indicating whether a article is tax exempt</returns>
        public virtual bool IsTaxExempt(Article article, Customer customer)
        {
            if (customer != null)
            {
