...
namespace YStory.Services.Topics
{
    /// <summary>
    /// Topic service
    /// </summary>
    public partial class TopicService : ITopicService
    {
        ...
        /// {2} : show hidden?
        /// </remarks>
        private const string TOPICS_ALL_KEY = "YStory.topics.all-{0}-{1}-{2}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : topic ID
        /// </remarks>
        private const string TOPICS_BY_ID_KEY = "YStory.topics.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string TOPICS_PATTERN_KEY = "YStory.topics.";
        ...
        public virtual IList<Topic> GetAllTopics(int storeId, bool ignorAcl = false, bool showHidden = false)
        {
            ...
            {
                var query = _topicRepository.Table;
                query = query.OrderBy(t => t.DisplaySubscription).ThenBy(t => t.SystemName);
