...
namespace YStory.Web.Framework
{
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseYStoryEntityModel
        {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseYStoryEntityModel
        {
        ...
        public static MvcHtmlString YStoryLabelFor<TModel, TValue>(this HtmlHelper<TModel> helper,
                Expression<Func<TModel, TValue>> expression, bool displayHint = true)
        {
            ...
            if (metadata.AdditionalValues.TryGetValue("YStoryResourceDisplayName", out value))
            {
                var resourceDisplayName = value as YStoryResourceDisplayName;
        ...
        public static MvcHtmlString YStoryEditorFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString YStoryDropDownList<TModel>(this HtmlHelper<TModel> helper, string name,
        ...
        public static MvcHtmlString YStoryDropDownListFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString YStoryTextAreaFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString YStoryDisplayFor<TModel, TValue>(this HtmlHelper<TModel> helper, Expression<Func<TModel, TValue>> expression)
        {
        ...
        public static MvcHtmlString YStoryDisplay<TModel>(this HtmlHelper<TModel> helper, string expression)
        {
            var result = new TagBuilder("div");
            result.Attributes.Add("class", "form-text-row");
