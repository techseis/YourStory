...
{
    public class YStoryResourceDisplayName : System.ComponentModel.DisplayNameAttribute, IModelAttribute
    {
        private string _resourceValue = string.Empty;
        //private bool _resourceValueRetrived;

        public YStoryResourceDisplayName(string resourceKey)
            : base(resourceKey)
        {
        ...
        public string Name
        {
            get { return "YStoryResourceDisplayName"; }
        }
    }
}
