...
namespace YStory.Web.Framework.Seo
{
    /// <summary>
            ...
            if (data != null && DataSettingsHelper.DatabaseIsInstalled())
            {
                ...
                switch (urlRecord.EntityName.ToLowerInvariant())
                {
                    ...
                    case "publisher":
                        {
                            data.Values["controller"] = "Catalog";
                            data.Values["action"] = "Publisher";
                            data.Values["publisherid"] = urlRecord.EntityId;
                            data.Values["SeName"] = urlRecord.Slug;
                        }
                        break;
                    case "contributor":
                        {
                            data.Values["controller"] = "Catalog";
                            data.Values["action"] = "Contributor";
                            data.Values["contributorid"] = urlRecord.EntityId;
                            data.Values["SeName"] = urlRecord.Slug;
                        }
                        break;
                    case "newsitem":
