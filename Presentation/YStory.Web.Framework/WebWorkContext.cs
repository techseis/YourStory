...
namespace YStory.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private const string CustomerCookieName = "YStory.customer";
        ...
        private Contributor _cachedContributor;
        ...
        /// </summary>
        public virtual Contributor CurrentContributor
        {
            get
            {
                ...
                var contributor = _contributorService.GetContributorById(currentCustomer.ContributorId);

                //validation
                if (contributor != null && !contributor.Deleted && contributor.Active)
                    _cachedContributor = contributor;
