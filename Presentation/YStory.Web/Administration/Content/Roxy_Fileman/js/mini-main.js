...
function Directory(fullPath, numDirs, numFiles){
  ...
  this.SortByName = function(files, subscription){
     files.sort(function(a, b){
       var x = (subscription == 'desc'?0:2)
  ...
  this.SortBySize = function(files, subscription){
     files.sort(function(a, b){
       var x = (subscription == 'desc'?0:2)
       a = parseInt(a.size);
       b = parseInt(b.size);
  ...
  this.SortByTime = function(files, subscription){
     files.sort(function(a, b){
       var x = (subscription == 'desc'?0:2)
       a = parseInt(a.time);
       b = parseInt(b.time);
  ...
  this.SortFiles = function(files){
    var subscription = $('#ddlSubscription').val();
    if(!subscription)
      subscription = 'name';
