...
using YStory.Admin.Models.Affiliates;
using YStory.Core;
    ...
    public partial class AffiliateController : BaseAdminController
    {
        ...
        public virtual ActionResult List(DataSourceRequest command, AffiliateListModel model)
        {
            ...
            var affiliates = _affiliateService.GetAllAffiliates(model.SearchFriendlyUrlName,
                ...
                model.LoadOnlyWithSubscriptions, model.SubscriptionsCreatedFromUtc, model.SubscriptionsCreatedToUtc,
        ...
        public virtual ActionResult AffiliatedSubscriptionListGrid(DataSourceRequest command, AffiliatedSubscriptionListModel model)
        {
            ...
            var subscriptionStatusIds = model.SubscriptionStatusId > 0 ? new List<int>() { model.SubscriptionStatusId } : null;
