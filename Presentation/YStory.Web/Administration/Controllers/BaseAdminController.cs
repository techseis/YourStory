...
namespace YStory.Admin.Controllers
{
    ...
    public abstract partial class BaseAdminController : BaseController
    {
        ...
        protected virtual void SaveSelectedTabName(string tabName = "", bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedTabName" method of \YStory.Web.Framework\HtmlExtensions.cs
        ...
        protected override JsonResult Json(object data, string contentType, Encoding contentEncoding, JsonRequestBehavior behavior)
        {
            ...
            //sometime our entities have big text values returned (e.g. article desriptions)
