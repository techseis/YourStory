...
namespace YStory.Admin.Controllers
{
    public partial class CommonController : BaseAdminController
    {
        ...
        public virtual ActionResult SystemInfo()
        {
            ...
            model.YStoryVersion = YStoryVersion.CurrentVersion;
            try
            {
                ...
                Data = urlRecords.Select(x =>
                {
                    ...
                    switch (entityName)
                    {
                        ...
                        case "category":
                            ...
                            break;
                        case "publisher":
                            detailsUrl = Url.Action("Edit", "Publisher", new { id = x.EntityId });
                            break;
                        case "article":
                            detailsUrl = Url.Action("Edit", "Article", new { id = x.EntityId });
                            break;
                        case "newsitem":
                        ...
                        case "topic":
                            ...
                            break;
                        case "contributor":
                            detailsUrl = Url.Action("Edit", "Contributor", new { id = x.EntityId });
                            break;
                        default:
                            break;
                    }
