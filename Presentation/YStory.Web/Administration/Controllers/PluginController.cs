...
namespace YStory.Admin.Controllers
{
    public partial class PluginController : BaseAdminController
	{
        ...
        public virtual ActionResult EditPopup(string btnId, string formId, PluginModel model)
        {
            ...
            {
                //we allow editing of 'friendly name', 'display subscription', store mappings
                pluginDescriptor.FriendlyName = model.FriendlyName;
                pluginDescriptor.DisplaySubscription = model.DisplaySubscription;
        ...
        public virtual ActionResult OfficialFeed()
        {
            ...
            var currentVersionItem = model.AvailableVersions.FirstOrDefault(x => x.Text.Contains(YStoryVersion.CurrentVersion));
