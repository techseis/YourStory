...
namespace YStory.Admin.Controllers
{
    public partial class PollController : BaseAdminController
	{
        ...
        public virtual ActionResult PollAnswers(int pollId, DataSourceRequest command)
        {
            ...
            var answers = poll.PollAnswers.OrderBy(x=>x.DisplaySubscription).ToList();
        ...
        public virtual ActionResult PollAnswerUpdate(PollAnswerModel model)
        {
            ...
            pollAnswer.DisplaySubscription = model.DisplaySubscription;
