...
namespace YStory.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        {
            return entity.MapTo<Publisher, PublisherModel>();
        }

        public static Publisher ToEntity(this PublisherModel model)
        {
            return model.MapTo<PublisherModel, Publisher>();
        }

        public static Publisher ToEntity(this PublisherModel model, Publisher destination)
        {
            return model.MapTo(destination);
        }
        ...
        public static ContributorModel ToModel(this Contributor entity)
        {
            return entity.MapTo<Contributor, ContributorModel>();
        }
        ...
        public static ArticleAttribute ToEntity(this ArticleAttributeModel model)
        {
            return model.MapTo<ArticleAttributeModel, ArticleAttribute>();
        }
        ...
        {
            //this method is very similar to the same one in YStory.Web project
        ...
        public static SubscriptionSettingsModel ToModel(this SubscriptionSettings entity)
        {
            return entity.MapTo<SubscriptionSettings, SubscriptionSettingsModel>();
        }
        public static SubscriptionSettings ToEntity(this SubscriptionSettingsModel model, SubscriptionSettings destination)
        {
            return model.MapTo(destination);
        }
        ...
        public static ArticleEditorSettingsModel ToModel(this ArticleEditorSettings entity)
        {
            return entity.MapTo<ArticleEditorSettings, ArticleEditorSettingsModel>();
        }
        public static ArticleEditorSettings ToEntity(this ArticleEditorSettingsModel model, ArticleEditorSettings destination)
        {
            return model.MapTo(destination);
        }
        #endregion
        ...
        public static ArticleTemplate ToEntity(this ArticleTemplateModel model)
        {
            return model.MapTo<ArticleTemplateModel, ArticleTemplate>();
        }
