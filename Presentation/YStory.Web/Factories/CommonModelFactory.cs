    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual FooterModel PrepareFooterModel()
        {
            ...
            var model = new FooterModel
            {
                ...
                CompareArticlesEnabled = _catalogSettings.CompareArticlesEnabled,
                ForumEnabled = _forumSettings.ForumsEnabled,
                NewsEnabled = _newsSettings.Enabled,
                RecentlyViewedArticlesEnabled = _catalogSettings.RecentlyViewedArticlesEnabled,
                NewArticlesEnabled = _catalogSettings.NewArticlesEnabled,
                DisplayTaxShippingInfoFooter = _catalogSettings.DisplayTaxShippingInfoFooter,
                HidePoweredByYourStory = _storeInformationSettings.HidePoweredByYourStory,
                AllowCustomersToApplyForContributorAccount = _contributorSettings.AllowCustomersToApplyForContributorAccount,
        ...
        public virtual SitemapModel PrepareSitemapModel()
        {
            ...
            var cachedModel = _cacheManager.Get(cacheKey, () =>
            {
                ...
                if (_commonSettings.SitemapIncludePublishers)
                {
                    ...
                    model.Publishers = publishers.Select(category => new PublisherBriefInfoModel
                    {
                        Id = category.Id,
                        Name = category.GetLocalized(x => x.Name),
                        SeName = category.GetSeName(),
                ...
                {
                    //limit article to 200 until paging is supported on this page
                    var articles = _articleService.SearchArticles(storeId: _storeContext.CurrentStore.Id,
                        visibleIndividuallyOnly: true,
                        pageSize: 200);
                    model.Articles = articles.Select(article => new ArticleOverviewModel
                    {
                        Id = article.Id,
        ...
        public virtual string PrepareRobotsTextFile()
        {
            ...
            else
            {
                ...
                {
                    "/addarticletocart/catalog/",
                    "/addarticletocart/details/",
