...
namespace YStory.Web.Factories
{
    ...
    public partial interface IShoppingCartModelFactory
    {
        ...
        PictureModel PrepareCartItemPictureModel(ShoppingCartItem sci, int pictureSize,bool showDefaultPicture, string articleName);
        ...
        SubscriptionTotalsModel PrepareSubscriptionTotalsModel(IList<ShoppingCartItem> cart, bool isEditable);
