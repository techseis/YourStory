...
{
    public partial class PopularArticleTagsModel : BaseYStoryModel
    {
        public PopularArticleTagsModel()
        {
        ...
        public virtual int GetFontSize(ArticleTagModel articleTag)
        {
            ...
            return GetFontSize(articleTag.ArticleCount, mean, stdDev);
        }
