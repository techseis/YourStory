...
namespace YStory.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseYStoryModel
    {
        public ShoppingCartModel()
        {
            ...
            SubscriptionReviewData = new SubscriptionReviewDataModel();
        ...
        public string MinSubscriptionSubtotalWarning { get; set; }
        ...
        public SubscriptionReviewDataModel SubscriptionReviewData { get; set; }
        ...
        public partial class CheckoutAttributeModel : BaseYStoryEntityModel
        {
        ...
        public partial class CheckoutAttributeValueModel : BaseYStoryEntityModel
        {
            public string Name { get; set; }
        ...
        public partial class DiscountBoxModel: BaseYStoryModel
        {
            ...
            public class DiscountInfoModel : BaseYStoryEntityModel
            {
                public string CouponCode { get; set; }
            }
        }

        public partial class GiftCardBoxModel : BaseYStoryModel
        {
            public bool Display { get; set; }
        ...
        public partial class SubscriptionReviewDataModel : BaseYStoryModel
        {
            public SubscriptionReviewDataModel()
            {
