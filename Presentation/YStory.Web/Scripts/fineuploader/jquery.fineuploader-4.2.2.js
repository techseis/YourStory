...
(function(){
    ...
    qq.safari   = function(){
        return navigator.contributor !== undefined && navigator.contributor.indexOf("Apple") !== -1;
    };
    qq.chrome   = function(){
        return navigator.contributor !== undefined && navigator.contributor.indexOf("Google") !== -1;
    };
    qq.opera   = function(){
        return navigator.contributor !== undefined && navigator.contributor.indexOf("Opera") !== -1;
    };
    qq.firefox  = function(){
        return (!qq.ie11() && navigator.userAgent.indexOf("Mozilla") !== -1 && navigator.contributor !== undefined && navigator.contributor === "");
    };
    qq.windows  = function(){
...
qq.UploadButton = function(o) {
    ...
    function createInput() {
        ...
        if (options.folders && qq.supportedFeatures.folderSelection) {
            // selecting directories is only possible in Chrome now, via a contributor-specific prefixed attribute
