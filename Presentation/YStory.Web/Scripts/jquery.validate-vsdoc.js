 ...
 * terms; or (ii) using the files as included with a Microsoft article subject
 * to that article's license terms. Microsoft reserves all other rights to the
...
* standard jQuery library for all articleion use.
*
